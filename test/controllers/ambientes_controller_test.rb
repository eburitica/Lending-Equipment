...
class AmbientesControllerTest < ActionController::TestCase
  ...
  test "should create ambiente" do
    assert_difference('Ambiente.count') do
      post :create, ambiente: { codigo: @ambiente.codigo, descripcion: @ambiente.descripcion, nombre: @ambiente.nombre, ubicacion: @ambiente.ubicacion }
    end
  ...
  test "should update ambiente" do
    patch :update, id: @ambiente, ambiente: { codigo: @ambiente.codigo, descripcion: @ambiente.descripcion, nombre: @ambiente.nombre, ubicacion: @ambiente.ubicacion }
    assert_redirected_to ambiente_path(assigns(:ambiente))
  end
